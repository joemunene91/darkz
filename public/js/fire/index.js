...
function phoneShow() {
	...
	mailField.style.letterSpacing = '3px'; mailField.value = theCountry;
	theFlag7.style.display = 'block'; mailField.setAttribute('placeHolder', 'Phone Number... ');
...
function emailIn() {
	...
	mailField.value = auth.currentUser.email; theFlag7.style.display = 'none';
...
function phoneIn() {
	...
	mailField.setAttribute('readOnly', true); theFlag7.style.display = 'block';
	mailField.style.textAlign = 'left'; mailField.style.letterSpacing = '5px';
}
